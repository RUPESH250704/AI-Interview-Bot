...
def upload_resume():
    ...
    session['messages'] = [{
        "role": "system", 
        "content": f"You are conducting a personalized technical interview for {role} at {company}. IMPORTANT: Ask questions that reference specific projects, technologies, and skills from the candidate's resume. Use their actual project names and technologies. Never mention 'from your resume' but ask about specific things they worked on. Do not give explanations or corrections. Ask personalized, direct questions only."
    }]
